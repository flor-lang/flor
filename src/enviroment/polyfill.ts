export enum Polyfill {
  ...
  INTERFACE_VLDT = "validateInterface:(e,a)=>{if(!e||!(e.__props__))throw new Error(`Objeto '${a}' não é uma interface para implementar em uma classe`)}",
  ...
  VLD_NUM_OP = 'vld_num_op:(o,e,r)=>{const n=__pf__.isBrowser()?window:global;if("number"!=typeof o||"number"!=typeof r)throw new Error(`Operador \'${e}\' não pode ser aplicado entre ${"function"==typeof n.tipo?`os tipos ${n.tipo(o)} e ${n.tipo(r)}`:"tipos não numéricos"}`)}',
